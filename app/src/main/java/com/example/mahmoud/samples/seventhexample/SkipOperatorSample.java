package com.example.mahmoud.samples.seventhexample;
...
public class SkipOperatorSample extends AppCompatActivity {
    ...
    private void refreshList() {
        Observable.fromIterable(getInstalledApps())
                 // .skip(2)
                //.skipLast(2)
                .elementAtOrError(2)//get the item at certain position
